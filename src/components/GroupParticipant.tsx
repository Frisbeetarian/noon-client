...
const GroupParticipant = ({ participant }) => {
  ...
  return (
    <Flex
      className="p-2 py-4 md:py-2 cursor:pointer items-center justify-between border-b hover:text-red-500 text-white cursor-pointer"
      style={{ backgroundColor: participantsColor }}
      onClick={() => {
        if (participantsColor === '') {
          setParticipantsColor('#921A1C')
