...
function ChatControlsAndSearch() {
  ...
  return (
    <Flex
      ref={ref.current}
      className="flex-col border-b px-3 w-full py-5 md:py-0 "
      style={{
    ...
    >
      <Flex className=" px-3 justify-start items-center h-full w-full ">
        <div
          className="flex items-center h-3 w-3 cursor-pointer w-1/4 "
          onClick={() => {
