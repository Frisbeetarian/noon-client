...
export type CancelFriendRequestMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'cancelFriendRequest'
>
...
export type CreateCommunityMutation = { __typename?: 'Mutation' } & {
  createCommunity: { __typename?: 'Community' } & Pick<
    Community,
    | 'id'
    | 'title'
    | 'description'
...
export type CallsSnippetFragment = {
  ...
  'profileUuid' | 'profileUsername' | 'pendingCall' | 'ongoingCall'
>

export type CommunitySnippetFragment = { __typename?: 'Community' } & Pick<
  Community,
  | 'id'
  | 'title'
  | 'description'
  ...
  | 'createdAt'
  | 'updatedAt'
> & { creator: { __typename?: 'User' } & Pick<User, 'uuid' | 'username'> }
...
> & {
    ...
    calls: Array<
      { __typename?: 'ConversationToProfile' } & CallsSnippetFragment
    >
...
export type ConversationToProfileSnippetFragment = {
  ...
  ConversationToProfile,
  'uuid' | 'unreadMessages' | 'profileThatHasUnreadMessages'
> & {
    profile: Array<
      { __typename?: 'Profile' } & ConversationProfileSnippetFragment
    >
...
export type EventSnippetFragment = { __typename?: 'Event' } & Pick<
  Event,
  | 'id'
  | 'title'
  | 'description'
...
export type FriendSnippetFragment = { __typename?: 'Friend' } & Pick<
  Friend,
  'uuid' | 'username'
>
...
export type MessageSnippetFragment = { __typename?: 'Message' } & Pick<
  Message,
  'uuid' | 'content' | 'updatedAt' | 'createdAt' | 'type' | 'src' | 'deleted'
> & { sender: { __typename?: 'Profile' } & Pick<Profile, 'uuid' | 'username'> }
...
> & {
    ...
    friends: Array<{ __typename?: 'Friend' } & FriendSnippetFragment>
    friendshipRequests: Array<
      { __typename?: 'FriendshipRequest' } & FriendshipRequestSnippetFragment
    >
  }
...
export type RegularProfileFragment = { __typename?: 'Profile' } & Pick<
  Profile,
  'uuid' | 'username'
>
...
export type RegularUserFragment = { __typename?: 'User' } & Pick<
  User,
  'uuid' | 'username' | 'email'
> & { profile: { __typename?: 'Profile' } & Pick<Profile, 'uuid' | 'username'> }
...
export type JoinCommunityMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'joinCommunity'
>
...
export type JoinEventMutation = { __typename?: 'Mutation' } & {
  joinEvent: { __typename?: 'Event' } & Pick<Event, 'timezone'>
}
...
export type CommunitiesQuery = { __typename?: 'Query' } & {
  communities: Array<{ __typename?: 'Community' } & CommunitySnippetFragment>
}
...
export type EventsQuery = { __typename?: 'Query' } & {
  events: { __typename?: 'PaginatedEvents' } & Pick<
    PaginatedEvents,
    'hasMore'
  > & { events: Array<{ __typename?: 'Event' } & EventSnippetFragment> }
}
...
export type GetCommunitiesParticipantsQuery = { __typename?: 'Query' } & {
  getCommunitiesParticipants: Array<
    { __typename?: 'CommunityParticipant' } & Pick<
      CommunityParticipant,
      'id' | 'profileId' | 'communityId' | 'participantUsername'
    >
  >
}
...
export type GetCommunityParticipantsQuery = { __typename?: 'Query' } & {
  getCommunityParticipants: Array<
    { __typename?: 'CommunityParticipant' } & Pick<
      CommunityParticipant,
      'id' | 'profileId' | 'participantUsername'
    >
  >
}

export type GetConversationForLoggedInUserQueryVariables = Exact<{
  [key: string]: never
}>

export type GetConversationForLoggedInUserQuery = { __typename?: 'Query' } & {
  getConversationForLoggedInUser?: Maybe<
    Array<{ __typename?: 'Conversation' } & ConversationSnippetFragment>
  >
}

export type GetConversationProfileForLoggedInUserQueryVariables = Exact<{
  [key: string]: never
}>
...
export type GetConversationsByProfileUuidQuery = { __typename?: 'Query' } & {
  getConversationsByProfileUuid?: Maybe<
    { __typename?: 'Conversation' } & ConversationSnippetFragment
  >
}
...
export type GetMessagesForConversationQuery = { __typename?: 'Query' } & {
  getMessagesForConversation: { __typename?: 'PaginatedMessages' } & Pick<
    PaginatedMessages,
    'hasMore'
  > & { messages: Array<{ __typename?: 'Message' } & MessageSnippetFragment> }
}
...
export type GetProfileByUserIdQuery = { __typename?: 'Query' } & {
  getProfileByUserId: { __typename?: 'Profile' } & Pick<
    Profile,
    'uuid' | 'username'
  >
}
...
export type GetProfilesQuery = { __typename?: 'Query' } & {
  getProfiles: Array<{ __typename?: 'Profile' } & ProfileSnippetFragment>
}
...
export type SearchForProfileByUuidQuery = { __typename?: 'Query' } & {
...
export type RefuseFriendRequestMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'refuseFriendRequest'
>
...
export type SaveGroupMessageMutation = { __typename?: 'Mutation' } & {
  saveGroupMessage: { __typename?: 'Message' } & Pick<Message, 'uuid'>
}
...
export type SaveMessageMutation = { __typename?: 'Mutation' } & {
  saveMessage: { __typename?: 'Message' } & Pick<Message, 'uuid'>
}
...
export type UploadImageMutation = { __typename?: 'Mutation' } & {
  uploadImage: { __typename?: 'Message' } & Pick<Message, 'uuid'>
}
...
export const CancelPendingCallForConversationDocument = gql`
  mutation CancelPendingCallForConversation(
...
`
export type CancelPendingCallForConversationMutationFn =
  Apollo.MutationFunction<
    CancelPendingCallForConversationMutation,
    CancelPendingCallForConversationMutationVariables
  >
...
export function useCancelPendingCallForConversationMutation(
  ...
  return Apollo.useMutation<
    CancelPendingCallForConversationMutation,
    CancelPendingCallForConversationMutationVariables
  >(CancelPendingCallForConversationDocument, options)
}
export type CancelPendingCallForConversationMutationHookResult = ReturnType<
  typeof useCancelPendingCallForConversationMutation
>
export type CancelPendingCallForConversationMutationResult =
  Apollo.MutationResult<CancelPendingCallForConversationMutation>
export type CancelPendingCallForConversationMutationOptions =
...
export const ClearUnreadMessagesForConversationDocument = gql`
  mutation ClearUnreadMessagesForConversation(
    $conversationUuid: String!
    $profileUuid: String!
  ) {
...
`
export type ClearUnreadMessagesForConversationMutationFn =
  Apollo.MutationFunction<
    ClearUnreadMessagesForConversationMutation,
    ClearUnreadMessagesForConversationMutationVariables
  >
...
export function useClearUnreadMessagesForConversationMutation(
  ...
  return Apollo.useMutation<
    ClearUnreadMessagesForConversationMutation,
    ClearUnreadMessagesForConversationMutationVariables
  >(ClearUnreadMessagesForConversationDocument, options)
}
export type ClearUnreadMessagesForConversationMutationHookResult = ReturnType<
  typeof useClearUnreadMessagesForConversationMutation
>
export type ClearUnreadMessagesForConversationMutationResult =
  Apollo.MutationResult<ClearUnreadMessagesForConversationMutation>
export type ClearUnreadMessagesForConversationMutationOptions =
  Apollo.BaseMutationOptions<
    ClearUnreadMessagesForConversationMutation,
    ClearUnreadMessagesForConversationMutationVariables
  >
...
export const CreateGroupConversationDocument = gql`
  ...
  ${ConversationSnippetFragmentDoc}
`
export type CreateGroupConversationMutationFn = Apollo.MutationFunction<
  CreateGroupConversationMutation,
  CreateGroupConversationMutationVariables
>
...
export function useCreateGroupConversationMutation(
  ...
  return Apollo.useMutation<
    CreateGroupConversationMutation,
    CreateGroupConversationMutationVariables
  >(CreateGroupConversationDocument, options)
}
export type CreateGroupConversationMutationHookResult = ReturnType<
  typeof useCreateGroupConversationMutation
>
export type CreateGroupConversationMutationResult =
  Apollo.MutationResult<CreateGroupConversationMutation>
export type CreateGroupConversationMutationOptions = Apollo.BaseMutationOptions<
  CreateGroupConversationMutation,
  CreateGroupConversationMutationVariables
>
...
`
export type JoinEventMutationFn = Apollo.MutationFunction<
  JoinEventMutation,
...
export function useJoinEventMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<JoinEventMutation, JoinEventMutationVariables>(
    JoinEventDocument,
    options
  )
}
...
export type JoinEventMutationOptions = Apollo.BaseMutationOptions<
  JoinEventMutation,
  JoinEventMutationVariables
>
 ...
 * });
 */
export function useCheckIfConversationHasMoreMessagesQuery(
  baseOptions: Apollo.QueryHookOptions<
    CheckIfConversationHasMoreMessagesQuery,
    CheckIfConversationHasMoreMessagesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    CheckIfConversationHasMoreMessagesQuery,
    CheckIfConversationHasMoreMessagesQueryVariables
  >(CheckIfConversationHasMoreMessagesDocument, options)
}
export function useCheckIfConversationHasMoreMessagesLazyQuery(
...
export type CheckIfConversationHasMoreMessagesQueryHookResult = ReturnType<
  typeof useCheckIfConversationHasMoreMessagesQuery
>
export type CheckIfConversationHasMoreMessagesLazyQueryHookResult = ReturnType<
  typeof useCheckIfConversationHasMoreMessagesLazyQuery
>
export type CheckIfConversationHasMoreMessagesQueryResult = Apollo.QueryResult<
  CheckIfConversationHasMoreMessagesQuery,
  CheckIfConversationHasMoreMessagesQueryVariables
>
 ...
 * });
 */
export function useGetCommunitiesParticipantsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCommunitiesParticipantsQuery,
    GetCommunitiesParticipantsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetCommunitiesParticipantsQuery,
    GetCommunitiesParticipantsQueryVariables
  >(GetCommunitiesParticipantsDocument, options)
}
export function useGetCommunitiesParticipantsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCommunitiesParticipantsQuery,
    GetCommunitiesParticipantsQueryVariables
  >
...
export type GetCommunitiesParticipantsQueryHookResult = ReturnType<
  typeof useGetCommunitiesParticipantsQuery
>
export type GetCommunitiesParticipantsLazyQueryHookResult = ReturnType<
  typeof useGetCommunitiesParticipantsLazyQuery
>
export type GetCommunitiesParticipantsQueryResult = Apollo.QueryResult<
  GetCommunitiesParticipantsQuery,
  GetCommunitiesParticipantsQueryVariables
>
 ...
 * });
 */
export function useGetCommunityParticipantsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCommunityParticipantsQuery,
    GetCommunityParticipantsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetCommunityParticipantsQuery,
    GetCommunityParticipantsQueryVariables
  >(GetCommunityParticipantsDocument, options)
}
export function useGetCommunityParticipantsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCommunityParticipantsQuery,
    GetCommunityParticipantsQueryVariables
  >
...
export type GetCommunityParticipantsQueryHookResult = ReturnType<
  typeof useGetCommunityParticipantsQuery
>
export type GetCommunityParticipantsLazyQueryHookResult = ReturnType<
  typeof useGetCommunityParticipantsLazyQuery
>
export type GetCommunityParticipantsQueryResult = Apollo.QueryResult<
  GetCommunityParticipantsQuery,
  GetCommunityParticipantsQueryVariables
>
 ...
 * });
 */
export function useGetConversationForLoggedInUserQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetConversationForLoggedInUserQuery,
    GetConversationForLoggedInUserQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetConversationForLoggedInUserQuery,
    GetConversationForLoggedInUserQueryVariables
  >(GetConversationForLoggedInUserDocument, options)
}
export function useGetConversationForLoggedInUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetConversationForLoggedInUserQuery,
    GetConversationForLoggedInUserQueryVariables
  >
...
export type GetConversationForLoggedInUserQueryHookResult = ReturnType<
  typeof useGetConversationForLoggedInUserQuery
>
export type GetConversationForLoggedInUserLazyQueryHookResult = ReturnType<
  typeof useGetConversationForLoggedInUserLazyQuery
>
export type GetConversationForLoggedInUserQueryResult = Apollo.QueryResult<
  GetConversationForLoggedInUserQuery,
  GetConversationForLoggedInUserQueryVariables
>
 ...
 * });
 */
export function useGetConversationProfileForLoggedInUserQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetConversationProfileForLoggedInUserQuery,
    GetConversationProfileForLoggedInUserQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetConversationProfileForLoggedInUserQuery,
    GetConversationProfileForLoggedInUserQueryVariables
  >(GetConversationProfileForLoggedInUserDocument, options)
}
export function useGetConversationProfileForLoggedInUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetConversationProfileForLoggedInUserQuery,
    GetConversationProfileForLoggedInUserQueryVariables
  >
...
export type GetConversationProfileForLoggedInUserQueryHookResult = ReturnType<
  typeof useGetConversationProfileForLoggedInUserQuery
>
export type GetConversationProfileForLoggedInUserLazyQueryHookResult =
  ReturnType<typeof useGetConversationProfileForLoggedInUserLazyQuery>
export type GetConversationProfileForLoggedInUserQueryResult =
  Apollo.QueryResult<
    GetConversationProfileForLoggedInUserQuery,
    GetConversationProfileForLoggedInUserQueryVariables
  >
 ...
 * });
 */
export function useGetConversationsByProfileUuidQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetConversationsByProfileUuidQuery,
    GetConversationsByProfileUuidQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetConversationsByProfileUuidQuery,
    GetConversationsByProfileUuidQueryVariables
  >(GetConversationsByProfileUuidDocument, options)
}
export function useGetConversationsByProfileUuidLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetConversationsByProfileUuidQuery,
    GetConversationsByProfileUuidQueryVariables
  >
...
export type GetConversationsByProfileUuidQueryHookResult = ReturnType<
  typeof useGetConversationsByProfileUuidQuery
>
export type GetConversationsByProfileUuidLazyQueryHookResult = ReturnType<
  typeof useGetConversationsByProfileUuidLazyQuery
>
export type GetConversationsByProfileUuidQueryResult = Apollo.QueryResult<
  GetConversationsByProfileUuidQuery,
  GetConversationsByProfileUuidQueryVariables
>
 ...
 * });
 */
export function useGetMessagesForConversationQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMessagesForConversationQuery,
    GetMessagesForConversationQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetMessagesForConversationQuery,
    GetMessagesForConversationQueryVariables
  >(GetMessagesForConversationDocument, options)
}
export function useGetMessagesForConversationLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetMessagesForConversationQuery,
    GetMessagesForConversationQueryVariables
  >
...
export type GetMessagesForConversationQueryHookResult = ReturnType<
  typeof useGetMessagesForConversationQuery
>
export type GetMessagesForConversationLazyQueryHookResult = ReturnType<
  typeof useGetMessagesForConversationLazyQuery
>
export type GetMessagesForConversationQueryResult = Apollo.QueryResult<
  GetMessagesForConversationQuery,
  GetMessagesForConversationQueryVariables
>
 ...
 * });
 */
export function useGetProfileByUserIdQuery(
  baseOptions: Apollo.QueryHookOptions<
  ...
  return Apollo.useQuery<
    GetProfileByUserIdQuery,
    GetProfileByUserIdQueryVariables
  >(GetProfileByUserIdDocument, options)
}
export function useGetProfileByUserIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProfileByUserIdQuery,
    GetProfileByUserIdQueryVariables
  >
...
export type GetProfileByUserIdQueryHookResult = ReturnType<
  typeof useGetProfileByUserIdQuery
>
export type GetProfileByUserIdLazyQueryHookResult = ReturnType<
  typeof useGetProfileByUserIdLazyQuery
>
export type GetProfileByUserIdQueryResult = Apollo.QueryResult<
  GetProfileByUserIdQuery,
  GetProfileByUserIdQueryVariables
>
...
export function useSearchForProfileByUsernameQuery(
  baseOptions: Apollo.QueryHookOptions<
    SearchForProfileByUsernameQuery,
    SearchForProfileByUsernameQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    SearchForProfileByUsernameQuery,
    SearchForProfileByUsernameQueryVariables
  >(SearchForProfileByUsernameDocument, options)
}
export function useSearchForProfileByUsernameLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchForProfileByUsernameQuery,
    SearchForProfileByUsernameQueryVariables
  >
...
export type SearchForProfileByUsernameQueryHookResult = ReturnType<
  typeof useSearchForProfileByUsernameQuery
>
export type SearchForProfileByUsernameLazyQueryHookResult = ReturnType<
  typeof useSearchForProfileByUsernameLazyQuery
>
export type SearchForProfileByUsernameQueryResult = Apollo.QueryResult<
  SearchForProfileByUsernameQuery,
  SearchForProfileByUsernameQueryVariables
>
 ...
 * });
 */
export function useSearchForProfileByUuidQuery(
  baseOptions: Apollo.QueryHookOptions<
    SearchForProfileByUuidQuery,
    SearchForProfileByUuidQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    SearchForProfileByUuidQuery,
    SearchForProfileByUuidQueryVariables
  >(SearchForProfileByUuidDocument, options)
}
export function useSearchForProfileByUuidLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchForProfileByUuidQuery,
    SearchForProfileByUuidQueryVariables
  >
...
export type SearchForProfileByUuidQueryHookResult = ReturnType<
  typeof useSearchForProfileByUuidQuery
>
export type SearchForProfileByUuidLazyQueryHookResult = ReturnType<
  typeof useSearchForProfileByUuidLazyQuery
>
export type SearchForProfileByUuidQueryResult = Apollo.QueryResult<
  SearchForProfileByUuidQuery,
  SearchForProfileByUuidQueryVariables
>
...
`
export type RefuseFriendRequestMutationFn = Apollo.MutationFunction<
  RefuseFriendRequestMutation,
  RefuseFriendRequestMutationVariables
>
...
export function useRefuseFriendRequestMutation(
  ...
  return Apollo.useMutation<
    RefuseFriendRequestMutation,
    RefuseFriendRequestMutationVariables
  >(RefuseFriendRequestDocument, options)
}
export type RefuseFriendRequestMutationHookResult = ReturnType<
  typeof useRefuseFriendRequestMutation
>
export type RefuseFriendRequestMutationResult =
  Apollo.MutationResult<RefuseFriendRequestMutation>
export type RefuseFriendRequestMutationOptions = Apollo.BaseMutationOptions<
  RefuseFriendRequestMutation,
  RefuseFriendRequestMutationVariables
>
...
`
export type SaveGroupMessageMutationFn = Apollo.MutationFunction<
  SaveGroupMessageMutation,
  SaveGroupMessageMutationVariables
>
...
export function useSaveGroupMessageMutation(
  ...
  return Apollo.useMutation<
    SaveGroupMessageMutation,
    SaveGroupMessageMutationVariables
  >(SaveGroupMessageDocument, options)
}
export type SaveGroupMessageMutationHookResult = ReturnType<
  typeof useSaveGroupMessageMutation
>
export type SaveGroupMessageMutationResult =
  Apollo.MutationResult<SaveGroupMessageMutation>
export type SaveGroupMessageMutationOptions = Apollo.BaseMutationOptions<
  SaveGroupMessageMutation,
  SaveGroupMessageMutationVariables
>
...
export const SetPendingCallForConversationDocument = gql`
  mutation SetPendingCallForConversation(
    $conversationUuid: String!
    $profileUuid: String!
  ) {
...
`
export type SetPendingCallForConversationMutationFn = Apollo.MutationFunction<
  SetPendingCallForConversationMutation,
  SetPendingCallForConversationMutationVariables
>
...
export function useSetPendingCallForConversationMutation(
  ...
  return Apollo.useMutation<
    SetPendingCallForConversationMutation,
    SetPendingCallForConversationMutationVariables
  >(SetPendingCallForConversationDocument, options)
}
export type SetPendingCallForConversationMutationHookResult = ReturnType<
  typeof useSetPendingCallForConversationMutation
>
export type SetPendingCallForConversationMutationResult =
  Apollo.MutationResult<SetPendingCallForConversationMutation>
export type SetPendingCallForConversationMutationOptions =
  Apollo.BaseMutationOptions<
    SetPendingCallForConversationMutation,
    SetPendingCallForConversationMutationVariables
  >
...
`
export type UnfriendMutationFn = Apollo.MutationFunction<
  UnfriendMutation,
...
export function useUnfriendMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<UnfriendMutation, UnfriendMutationVariables>(
    UnfriendDocument,
    options
  )
}
...
export type UnfriendMutationOptions = Apollo.BaseMutationOptions<
  UnfriendMutation,
  UnfriendMutationVariables
>
export const UpdateUnreadMessagesForConversationDocument = gql`
  mutation UpdateUnreadMessagesForConversation(
    $conversationUuid: String!
    $profileUuid: String!
  ) {
...
`
export type UpdateUnreadMessagesForConversationMutationFn =
  Apollo.MutationFunction<
    UpdateUnreadMessagesForConversationMutation,
    UpdateUnreadMessagesForConversationMutationVariables
  >
...
export function useUpdateUnreadMessagesForConversationMutation(
  ...
  return Apollo.useMutation<
    UpdateUnreadMessagesForConversationMutation,
    UpdateUnreadMessagesForConversationMutationVariables
  >(UpdateUnreadMessagesForConversationDocument, options)
}
export type UpdateUnreadMessagesForConversationMutationHookResult = ReturnType<
  typeof useUpdateUnreadMessagesForConversationMutation
>
export type UpdateUnreadMessagesForConversationMutationResult =
  Apollo.MutationResult<UpdateUnreadMessagesForConversationMutation>
export type UpdateUnreadMessagesForConversationMutationOptions =
  Apollo.BaseMutationOptions<
    UpdateUnreadMessagesForConversationMutation,
    UpdateUnreadMessagesForConversationMutationVariables
  >
